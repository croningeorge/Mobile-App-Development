...
using System.Net;
using Pertamina.LPG.API.DTOs.OrderPickup;
...
namespace Pertamina.LPG.API.Controllers
{
    ...
    public class OrdersController : ApiController
    {
        ...
        public NegotiatedContentResult<Pertamina.LPG.API.DTOs.Driver.GetEReceiptResponse> PostGetEreceiptDriver([FromBody] Pertamina.LPG.API.DTOs.Driver.GetEReceiptRequest request)
        {
            Pertamina.LPG.API.DTOs.Driver.GetEReceiptResponse resp = _driverServices.GetERecieptDetails(request);
            return Content(HttpStatusCode.OK, resp);
        }
        /// <summary>
        /// Get driver e-receipt
